...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    ...
    var c0_var_z = 0;
     ...
     c0_var_y  =  1 | 0;
     c0_var_z  =  2 | 0;
     c0_var_a  = (( 0  | 0) - ( 1  | 0) | 0) + ( 2  | 0)| 0;
     c0_var_b  = polyDiv(imul( 0  | 0, 1  | 0) | 0 | 0, 2  | 0) | 0| 0;
     c0_var_c  = (-( 2  | 0))| 0;
     c0_var_d  = polyMod( 1  | 0, 2  | 0) | 0| 0;
     c0_var_ret  =  0 | 0;
     c0_var_ret  = ( c0_var_ret  | 0) + ( c0_var_a  | 0)| 0;
     c0_var_ret  = ( c0_var_ret  | 0) - ( c0_var_b  | 0)| 0;
     c0_var_ret  = imul( c0_var_ret  | 0, c0_var_c  | 0) | 0| 0;
     c0_var_ret  = polyDiv( c0_var_ret  | 0, 2  | 0) | 0| 0;
    return ( c0_var_ret  | 0);
