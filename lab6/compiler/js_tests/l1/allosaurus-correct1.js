...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    var temp_ptr = 0;
    var c0_var_product = 0;
    var c0_var_sum = 0;
    var c0_var_x = 0;
     c0_var_x  =  4 | 0;
     c0_var_product  = imul( 4  | 0, 3  | 0) | 0| 0;
     c0_var_sum  = ( 4  | 0) + ( 3  | 0)| 0;
     c0_var_product  = imul( c0_var_product  | 0, 2  | 0) | 0| 0;
     c0_var_sum  = ( c0_var_sum  | 0) + ( 2  | 0)| 0;
     c0_var_product  = imul( c0_var_product  | 0, 1  | 0) | 0| 0;
     c0_var_sum  = ( c0_var_sum  | 0) + ( 1  | 0)| 0;
    return (( c0_var_product  | 0) - ( c0_var_sum  | 0) | 0);
