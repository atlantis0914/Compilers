...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    ...
    var c0_var_rsi = 0;
     ...
     c0_var_rdi  =  16 | 0;
     c0_var_rsi  =  32 | 0;
     c0_var_r8  = imul( 32  | 0, 2  | 0) | 0| 0;
     c0_var_rbx  = polyDiv( 32  | 0, 16  | 0) | 0| 0;
     c0_var_rsi  = polyDiv( c0_var_r8  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_rdi  = polyDiv( c0_var_rsi  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_rdx  = polyDiv( c0_var_rdi  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_rcx  = polyDiv( c0_var_rdx  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_rbx  = polyDiv( c0_var_rcx  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_rax  = polyDiv( c0_var_rbx  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_rbx  = polyDiv( c0_var_rdx  | 0, c0_var_rcx  | 0) | 0| 0;
     c0_var_r8  = imul( c0_var_rsi  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_rbx  = polyDiv( c0_var_rsi  | 0, c0_var_rdi  | 0) | 0| 0;
     c0_var_rsi  = polyDiv( c0_var_r8  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_rdi  = polyDiv( c0_var_rsi  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_rdx  = polyDiv( c0_var_rdi  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_rcx  = polyDiv( c0_var_rdx  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_rbx  = polyDiv( c0_var_rcx  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_rax  = polyDiv( c0_var_rbx  | 0, c0_var_rbx  | 0) | 0| 0;
     c0_var_r8  =  c0_var_rax | 0;
     c0_var_rax  =  c0_var_rbx | 0;
     c0_var_rbx  =  c0_var_rcx | 0;
     c0_var_rcx  =  c0_var_rdx | 0;
     c0_var_rdx  =  c0_var_rdi | 0;
     c0_var_rdi  =  c0_var_rsi | 0;
     c0_var_rsi  = imul( c0_var_rsi  | 0, c0_var_rax  | 0) | 0| 0;
    return ((((((( c0_var_rax  | 0) + ( c0_var_rbx  | 0) | 0) + ( c0_var_rcx  | 0) | 0) + ( c0_var_rdx  | 0) | 0) + ( c0_var_rdi  | 0) | 0) + ( c0_var_rsi  | 0) | 0) + ( c0_var_r8  | 0) | 0);
