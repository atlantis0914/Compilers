...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    ...
    var c0_var_twopow = 0;
     c0_var_twopow  =  2 | 0;
     c0_var_a  = ( 2  | 0) + ( 3  | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_b  = imul( c0_var_a  | 0, c0_var_twopow  | 0) | 0| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_c  = polyMod( c0_var_b  | 0, c0_var_twopow  | 0) | 0| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_d  = ( c0_var_twopow  | 0) + ( c0_var_c  | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_e  = ( c0_var_twopow  | 0) - ( c0_var_d  | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_f  = polyDiv( c0_var_twopow  | 0, 12  | 0) | 0| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_g  = ( c0_var_twopow  | 0) - ( 5  | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_h  = ( c0_var_twopow  | 0) - (imul( c0_var_g  | 0, 2  | 0) | 0 | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_i  = ( c0_var_twopow  | 0) - (imul( c0_var_h  | 0, 50  | 0) | 0 | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_j  = polyDiv(( c0_var_twopow  | 0) - ( 1000  | 0) | 0, c0_var_i  | 0) | 0| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_k  = ( c0_var_twopow  | 0) + ( c0_var_j  | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_l  = (imul( c0_var_k  | 0, 2  | 0) | 0 | 0) - ( c0_var_twopow  | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_m  = ( c0_var_twopow  | 0) + (imul( 2  | 0, c0_var_l  | 0) | 0 | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_n  = ( c0_var_twopow  | 0) - ( c0_var_m  | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_o  = ( c0_var_twopow  | 0) - (imul( 4  | 0, c0_var_n  | 0) | 0 | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_p  = polyDiv( c0_var_twopow  | 0, c0_var_o  | 0) | 0| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_q  = ( c0_var_p  | 0) - (polyDiv( c0_var_twopow  | 0, 100  | 0) | 0 | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_r  = polyMod(( c0_var_twopow  | 0) + ( 1  | 0) | 0, c0_var_q  | 0) | 0| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_s  = (( c0_var_twopow  | 0) + ( c0_var_r  | 0) | 0) + ( 75557  | 0)| 0;
     c0_var_twopow  = imul( c0_var_twopow  | 0, 2  | 0) | 0| 0;
     c0_var_prime  =  182921 | 0;
     c0_var_divres  = polyDiv( c0_var_twopow  | 0, 182921  | 0) | 0| 0;
    return ((polyDiv( c0_var_s  | 0, 100000  | 0) | 0 | 0) + ( c0_var_divres  | 0) | 0);
