...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    ...
    var c0_var_y = 0;
     c0_var_x  =  1 | 0;
     c0_var_y  =  0 | 0;
     c0_var_y  = ( c0_var_y  | 0) + ( 1  | 0)| 0;
     c0_var_x  = ( c0_var_x  | 0) + ( c0_var_y  | 0)| 0;
     c0_var_y  = ( c0_var_y  | 0) + ( c0_var_x  | 0)| 0;
     c0_var_x  = ( c0_var_x  | 0) + ( c0_var_y  | 0)| 0;
     c0_var_y  = ( c0_var_y  | 0) + ( c0_var_x  | 0)| 0;
     c0_var_x  = ( c0_var_x  | 0) + ( c0_var_y  | 0)| 0;
     c0_var_y  = imul( c0_var_y  | 0, c0_var_x  | 0) | 0| 0;
     c0_var_y  = polyDiv( c0_var_y  | 0, 4  | 0) | 0| 0;
     c0_var_y  = polyMod( c0_var_y  | 0, c0_var_x  | 0) | 0| 0;
     c0_var_y  = ( c0_var_y  | 0) - ( 1  | 0)| 0;
    return (imul( c0_var_x  | 0, c0_var_y  | 0) | 0 | 0);
