...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    ...
    var c0_var_v9 = 0;
     ...
     c0_var_v2  = ( 0  | 0) + ( 4  | 0)| 0;
     c0_var_v3  = (-( 0  | 0))| 0;
     c0_var_v1  = ( c0_var_v1  | 0) - ( 1  | 0)| 0;
     c0_var_v4  =  0 | 0;
     c0_var_v5  = (-( 8  | 0))| 0;
     c0_var_v1  = ( c0_var_v1  | 0) + ( 1  | 0)| 0;
    while ((!(( c0_var_v4  | 0) != ( c0_var_v0  | 0) | 0))){
       c0_var_v6  =  9 | 0;
       c0_var_v6  = polyMod( c0_var_v6  | 0, c0_var_v3  | 0) | 0| 0;
      while (( 3  | 0) < ( 6  | 0)){
         c0_var_v7  =  7 | 0;
         c0_var_v8  =  c0_var_v5 | 0;
         c0_var_v3 ;
         c0_var_v9  = polyDiv((~( 0  | 0)) | 0, 5  | 0) | 0| 0;
         c0_var_v10  =  c0_var_v9 | 0;
         c0_var_v11  = ( 5  | 0) | ( 2  | 0)| 0;
         c0_var_v5  =  7 | 0;
        return ( c0_var_v5  | 0);
      }
       c0_var_v7  =  9 | 0;
       c0_var_v8  =  c0_var_v2 | 0;
       c0_var_v9  =  c0_var_v0 | 0;
       c0_var_v0  = ( c0_var_v0  | 0) + ( 1  | 0)| 0;
       c0_var_v10  =  c0_var_v9 | 0;
       4 ;
       c0_var_v9  = polyMod( c0_var_v9  | 0, c0_var_v8  | 0) | 0| 0;
    }
     c0_var_v1  = polyDiv( c0_var_v1  | 0,( c0_var_v0  | 0) & ( 0  | 0) | 0) | 0| 0;
     c0_var_v5  = ( c0_var_v2  | 0) + ( 1  | 0)| 0;
     c0_var_v6  =  c0_var_v5 | 0;
     c0_var_v7  = (-( 7  | 0))| 0;
     c0_var_v8  = ( 4  | 0) ^ ( 0  | 0)| 0;
     c0_var_v2  = imul( c0_var_v2  | 0, 0  | 0) | 0| 0;
     c0_var_v2  =  5 | 0;
    (-((~( c0_var_v0  | 0)) | 0));
     c0_var_v0  = ( c0_var_v0  | 0) + ( 1  | 0)| 0;
    return ( c0_var_v3  | 0);
