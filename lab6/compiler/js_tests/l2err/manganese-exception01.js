...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    ...
    var c0_var_z = 0;
     c0_var_x  =  0 | 0;
     c0_var_y  = ( 0  | 0) + ( 1  | 0)| 0;
     c0_var_z  = ( c0_var_y  | 0) + ( 1  | 0)| 0;
     c0_var_w  = ( c0_var_z  | 0) + ( 1  | 0)| 0;
    if (((((((( c0_var_x  | 0) < ( c0_var_y  | 0) | 0) ? (( c0_var_y  | 0) < ( c0_var_z  | 0) | 0) : ( 0  | 0)) | 0) ? (( c0_var_z  | 0) < ( c0_var_w  | 0) | 0) : ( 0  | 0)) | 0) ? (( c0_var_w  | 0) < ( c0_var_x  | 0) | 0) : ( 0  | 0))){
      return ( 0  | 0);
    }
    else {
    }
