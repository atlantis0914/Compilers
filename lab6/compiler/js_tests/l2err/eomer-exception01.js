...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    ...
    var c0_var_i = 0;
     ...
     c0_var_b  =  100 | 0;
     c0_var_i  =  17 | 0;
    while (( c0_var_i  | 0) > ( 0  | 0)){
      if (( c0_var_i  | 0) > (polyDiv( c0_var_a  | 0, 2  | 0) | 0 | 0)){
         c0_var_b  = polyDiv( c0_var_b  | 0, c0_var_i  | 0) | 0| 0;
      }
      else {
        if ((((( 0  | 0) ? ( 1  | 0) : ( 0  | 0)) | 0) ? ( 1  | 0) : ( 1  | 0))){
           c0_var_b  = ( c0_var_b  | 0) - ( 1  | 0)| 0;
        }
        else {
           c0_var_b  = ( c0_var_b  | 0) + ( 50  | 0)| 0;
        }
      }
       c0_var_i  = ( c0_var_i  | 0) - ( 1  | 0)| 0;
    }
     c0_var_b  = polyDiv( c0_var_b  | 0, 17  | 0) | 0| 0;
    return (polyDiv(polyLShift( 1  | 0, 31  | 0) | 0 | 0,(~( c0_var_b  | 0)) | 0) | 0 | 0);
