...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    ...
    var c0_var_y = 0;
     ...
     c0_var_t  =  1 | 0;
     c0_var_i  =  1 | 0;
    while (( c0_var_i  | 0) <= ( 5  | 0)){
       c0_var_t  = imul( c0_var_t  | 0, c0_var_i  | 0) | 0| 0;
    ...
    if (( c0_var_x  | 0) < ( 2  | 0)){
       ...
       c0_var_f2  =  1 | 0;
       c0_var_n  =  0 | 0;
      while (( c0_var_n  | 0) <= ( 100  | 0)){
         c0_var_t  = ( c0_var_f1  | 0) + ( c0_var_f2  | 0)| 0;
         c0_var_f1  =  c0_var_f2 | 0;
         c0_var_f2  =  c0_var_t | 0;
         c0_var_n  = ( c0_var_n  | 0) + ( 1  | 0)| 0;
      }
       c0_var_f  =  1 | 0;
    }
    else {
