...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    var temp_ptr = 0;
    var c0_var_counter = 0;
    var c0_var_divisor = 0;
    var c0_var_num = 0;
     c0_var_num  =  148553800 | 0;
     c0_var_counter  =  0 | 0;
     c0_var_divisor  =  99 | 0;
    while (( c0_var_divisor  | 0) >= ( 0  | 0)){
       c0_var_counter  = ( c0_var_counter  | 0) + (polyDiv( c0_var_num  | 0, c0_var_divisor  | 0) | 0 | 0)| 0;
      if ((polyMod( c0_var_divisor  | 0, 2  | 0) | 0 | 0) == ( 0  | 0)){
         c0_var_divisor  = ( c0_var_divisor  | 0) - ( 1  | 0)| 0;
      }
      else {
         c0_var_divisor  = ( c0_var_divisor  | 0) - ( 3  | 0)| 0;
      }
    }
    return ( c0_var_counter  | 0);
