...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    ...
    var c0_var_m = 0;
    var c0_var_n = 0;
     c0_var_n  =  254837849 | 0;
     c0_var_m  =  1 | 0;
     c0_var_b  =  0 | 0;
    while (( c0_var_n  | 0) > ( 0  | 0)){
      if ((polyMod( c0_var_n  | 0, 2  | 0) | 0 | 0) == ( 0  | 0)){
         c0_var_d0  =  0 | 0;
      }
      else {
         c0_var_d0  =  1 | 0;
      ...
      if ((!( c0_var_d0  | 0))){
         c0_var_m  = imul( c0_var_m  | 0, 10  | 0) | 0| 0;
      }
      else {
         c0_var_b  = ( c0_var_m  | 0) + ( c0_var_b  | 0)| 0;
         c0_var_m  = imul( c0_var_m  | 0, 10  | 0) | 0| 0;
      }
       c0_var_n  = polyDiv( c0_var_n  | 0, 2  | 0) | 0| 0;
    }
    return ( c0_var_b  | 0);
