...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    var temp_ptr = 0;
    var c0_var_modified_x = 0;
    var c0_var_x = 0;
     c0_var_x  =  17895697 | 0;
     c0_var_modified_x  = (((polyRShift( 17895697  | 0, 24  | 0) | 0 | 0) & (polyRShift( 17895697  | 0, 16  | 0) | 0 | 0) | 0) & (polyRShift( 17895697  | 0, 8  | 0) | 0 | 0) | 0) & ( 17895697  | 0)| 0;
     c0_var_modified_x  = ( 85  | 0) ^ (( 85  | 0) & ( c0_var_modified_x  | 0) | 0)| 0;
    if (( c0_var_modified_x  | 0) != ( 0  | 0)){
      return (polyDiv( c0_var_modified_x  | 0, 0  | 0) | 0 | 0);
    }
    else {
      return ( 1  | 0);
    }
