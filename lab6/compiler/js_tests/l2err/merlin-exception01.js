...
function c0module(stdlib, foreign, heap) {
  ...
  function _c0_main () {
    ...
    while ( 1 ){
       c0_var_b  =  0 | 0;
      while (( c0_var_b  | 0) < ( 195816623  | 0)){
         c0_var_c  =  0 | 0;
        while (( c0_var_c  | 0) < ( 12513262  | 0)){
           c0_var_x  = ((~((-((~((-((~((-((~((-( 3735928559  | 0)) | 0)) | 0)) | 0)) | 0)) | 0)) | 0)) | 0)) | 0) ^ (polyRShift(polyLShift(polyDiv((((~( c0_var_b  | 0)) | 0) ^ ((-( 1  | 0)) | 0) | 0) | ( c0_var_c  | 0) | 0, c0_var_a  | 0) | 0 | 0, 31  | 0) | 0 | 0, 31  | 0) | 0 | 0)| 0;
           c0_var_c  = ( c0_var_c  | 0) + ( 1  | 0)| 0;
        }
         c0_var_b  = ( c0_var_b  | 0) + ( 1  | 0)| 0;
      }
       c0_var_a  = ( c0_var_a  | 0) + ( 2  | 0)| 0;
    }
    return ( c0_var_a  | 0);
